...
## Libraries
- [ ] Finish reading every part of Cats documentation
- [ ] Finish reading every part of Cats Effects documentation
- [ ] Try using [fs2](https://fs2.io/guide.html) in a project
- [ ] Get in more confidence with [http4s](https://http4s.org/v0.21)
- [ ] Try using [Ciris](https://cir.is/)
